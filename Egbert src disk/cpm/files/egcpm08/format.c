...
#define WPORT0   0x00    /* write data         */ 
#define WPORT1   0x01    /* software reset     */
#define WPORT2   0x02    /* select contrtoller */
#define RPORT0   0x00    /* read data          */
#define RPORT1   0x01    /* read status        */
