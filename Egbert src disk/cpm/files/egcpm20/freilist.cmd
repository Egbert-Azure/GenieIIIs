* Freiprint - listet Mitglieder welche mit der Adressenweitergabe
*             einverstanden sind
*----------------------------------------------------------------
erase
clear
...
do while mkz <3 .and. mkz <> 0
   ...
   store trim(vorname) + " " +TRIM(NAME) + "    "+ trim(FREI) to &such
