* Program..: IN-UPDTE.PRG
* Author(s): Roy M. Moore
* Date.....: 01-10-84
* Notice...: Copyright 1984, ASHTON-TATE, All Rights Reserved.
*	     May not be reproduced without permission.
* Notes....: This program allows the user to modify existing records or
*	     to find any record in the file.
ERASE
@ 1,0 SAY "Inventory Update"
@ 2,0 SAY line
@ 19,0 SAY line
IF # = 0
...
DO WHILE T
   ...
   @ 21,15 SAY "(F)ind, (C)hange, (D)elete, (U)ndelete, (S)kip:"
   DO WHILE badans
      @ 21,62 GET mchoice PICTURE "!"
      READ
      IF mchoice$"FCDSU "
	 STORE F TO badans
      ENDIF
