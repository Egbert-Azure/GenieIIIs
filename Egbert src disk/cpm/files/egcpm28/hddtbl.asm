...
;
;	10 01 05 1f 01 1f 0a ff 03 ff 00 00 80 02 00 02 03 ; Partition 0
;	10 01 05 1f 01 39 0a ff 03 ff 00 00 80 33 01 02 03 ; Partition 1
;
...
hddph0	hdpb	512,68,307,4096,1024,2,8000h	;partition 0
hddph1	hdpb	512,68,615,4096,1024,307,8000h	;partition 1
