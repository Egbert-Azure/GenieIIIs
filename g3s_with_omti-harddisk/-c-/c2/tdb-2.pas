...
const FormMask : array[1..8] of MaskEintr =
      ...
      AusForm : AusgabeFormat =
                  (Format:'1/'; KopfZeile:'Seite #'; FussZeile:''; Zeilen:23;
...
(*$I c5:TDB-00.INC           Index-Zugriffe                          *)
...
(*$I c5:TDB-03.INC*)         {  Untermenue Bearbeiten     }
(*$I c5:TDB-04.INC*)         {  Untermenue Ausgabe        }
(*$I c5:TDB-05.INC*)         {  Untermenue Indizierung    }
  ...
  begin
    ...
    if Umleitung then
      ...
      if EOF(TextFile) then c:=^[ else read(TextFile,c)
    	 ...
    	 (* fuer Genie 3s mit Holte CP/M 3.0 nicht noetig *)
    	 (* steht alles in cpm3/sys                       *)
      begin
        read(kbd,c);
