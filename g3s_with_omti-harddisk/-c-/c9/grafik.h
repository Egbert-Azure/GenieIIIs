...
void askpoint (int x, int y);           /* fragt ob Punkt gesetzt             */
void line (int x1, int y1, int x2, int y2);
					/* zieht Linie (links,unten,
					                rechts,oben)	      */	
void arc (int x, int y, int x0, int y0, int x1, int y1);
					/* Kreisbogen (mittel_x,y,start_x,
					               y,end_x,y     	      */
...
void unline (int x1, int y1, int x2, int y2);
				        /* loescht eine Line		      */
void uncircle (int x, int y, int r);	/* loescht einen Kreis mittelpunkt_x,
								y radius      */
void unarc (int x, int y, int x0, int y0, int x1, int y1);
					/* loescht einen Kreisbogen 
					   mittelpunkt_y,y radius             */
